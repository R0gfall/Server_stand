...
.method private final navigate(Landroidx/navigation/NavDestination;Landroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    invoke-direct {v10, v7, v0, v11, v12}, Landroidx/navigation/NavController$navigate$4;-><init>(Lkotlin/jvm/internal/Ref$BooleanRef;Landroidx/navigation/NavController;Landroidx/navigation/NavDestination;Landroid/os/Bundle;)V
    ...
    .line 1840
    .local v9, "$i$a$-forEach-NavController$navigate$5":I
    ...
    .end local v9    # "$i$a$-forEach-NavController$navigate$5":I
    nop
...
.method public navigate(ILandroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    .line 1628
    .local v1, "currentNode":Landroidx/navigation/NavDestination;
    move v2, p1

    .line 1629
    .local v2, "destId":I
    invoke-virtual {v1, p1}, Landroidx/navigation/NavDestination;->getAction(I)Landroidx/navigation/NavAction;

    move-result-object v3

    .line 1630
    .local v3, "navAction":Landroidx/navigation/NavAction;
    const/4 v4, 0x0

    .line 1631
    .local v4, "combinedArgs":Landroid/os/Bundle;
    if-eqz v3, :cond_2
    ...
    invoke-virtual {v0}, Landroidx/navigation/NavOptions;->getPopUpToId()I
    ...
    invoke-virtual {v0}, Landroidx/navigation/NavOptions;->isPopUpToInclusive()Z

    move-result v6

    invoke-virtual {p0, v5, v6}, Landroidx/navigation/NavController;->popBackStack(IZ)Z
    ...
    invoke-virtual {v8, v9, v2}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 1659
    .local v5, "$i$a$-require-NavController$navigate$2":I
    ...
    const-string v10, " referenced from action "
    ...
    .line 1660
    sget-object v10, Landroidx/navigation/NavDestination;->Companion:Landroidx/navigation/NavDestination$Companion;

    iget-object v11, p0, Landroidx/navigation/NavController;->context:Landroid/content/Context;

    invoke-virtual {v10, v11, p1}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 1658
    .end local v5    # "$i$a$-require-NavController$navigate$2":I
    ...
    const-string v10, "Navigation action/destination "
    ...
    invoke-direct {p0, v7, v4, v0, v5}, Landroidx/navigation/NavController;->navigate(Landroidx/navigation/NavDestination;Landroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    .line 1653
    .local v6, "$i$a$-require-NavController$navigate$1":I
    nop

    .line 1652
    .end local v6    # "$i$a$-require-NavController$navigate$1":I
    new-instance v6, Ljava/lang/IllegalArgumentException;

    const-string v7, "Destination id == 0 can only be used in conjunction with a valid navOptions.popUpTo"
    ...
    .line 1625
    .end local v1    # "currentNode":Landroidx/navigation/NavDestination;
    .end local v2    # "destId":I
    .end local v3    # "navAction":Landroidx/navigation/NavAction;
    .end local v4    # "combinedArgs":Landroid/os/Bundle;
    :cond_b
    move-object/from16 v5, p4
...
.method public navigate(Landroidx/navigation/NavDeepLinkRequest;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    .local v5, "$this$navigate_u24lambda_u2433":Landroid/content/Intent;
    const/4 v6, 0x0
    ...
    .line 1780
    .end local v5    # "$this$navigate_u24lambda_u2433":Landroid/content/Intent;
...
.method public restoreState(Landroid/os/Bundle;)V
    ...
    .local v14, "$this$restoreState_u24lambda_u2454_u24lambda_u2453":Lkotlin/collections/ArrayDeque;
    const/4 v15, 0x0
    ...
    .end local v2    # "backStackDestIds":[I
    .end local v3    # "backStackIds":Ljava/util/ArrayList;
    .end local v14    # "$this$restoreState_u24lambda_u2454_u24lambda_u2453":Lkotlin/collections/ArrayDeque;
...
.method public setOnBackPressedDispatcher(Landroidx/activity/OnBackPressedDispatcher;)V
    ...
    .local v1, "$this$setOnBackPressedDispatcher_u24lambda_u2456":Landroidx/lifecycle/Lifecycle;
    const/4 v2, 0x0
    ...
    .line 2346
    .end local v1    # "$this$setOnBackPressedDispatcher_u24lambda_u2456":Landroidx/lifecycle/Lifecycle;
