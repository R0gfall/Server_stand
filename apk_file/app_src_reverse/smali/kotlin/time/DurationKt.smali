...
.method private static final parseDuration(Ljava/lang/String;Z)J
    ...
    const-string v10, "Unexpected order of duration components"
    ...
    .local v20, "nonDigitSymbols":Ljava/lang/String;
    ...
    .line 1371
    .local v24, "$i$a$-substringWhile-DurationKt$parseDuration$component$1":I
    ...
    .local v18, "hasSign":Z
    .local v26, "length":I
    invoke-direct {v4, v11, v6}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v4, v5}, Lkotlin/ranges/CharRange;->contains(C)Z
    ...
    invoke-static {v4, v5, v12, v11, v6}, Lkotlin/text/StringsKt;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    .end local v12    # "isNegative":Z
    .restart local v17    # "isNegative":Z
    :goto_6
    const/4 v4, 0x1

    .line 1501
    .end local v5    # "it":C
    .end local v24    # "$i$a$-substringWhile-DurationKt$parseDuration$component$1":I
    :goto_7
    if-eqz v4, :cond_a
    ...
    .line 1376
    invoke-static {v0, v13}, Lkotlin/time/DurationUnitKt;->durationUnitByIsoChar(CZ)Lkotlin/time/DurationUnit;
    ...
    .end local v17    # "isNegative":Z
    .end local v18    # "hasSign":Z
    .end local v20    # "nonDigitSymbols":Ljava/lang/String;
    ...
    .restart local v17    # "isNegative":Z
    .restart local v18    # "hasSign":Z
    .restart local v20    # "nonDigitSymbols":Ljava/lang/String;
    ...
    .restart local v5    # "allowSpaces":Z
    .restart local v11    # "$i$f$substringWhile":I
    .restart local v13    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    :cond_1e
    move/from16 v22, v5
    ...
    .restart local v24    # "$i$f$substringWhile":I
    :cond_1f
    nop
    ...
    .line 1411
    .local v21, "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    move/from16 v24, v4
    ...
    invoke-direct {v4, v5, v14}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v4, v13}, Lkotlin/ranges/CharRange;->contains(C)Z

    move-result v4

    .line 1516
    .end local v13    # "it":C
    .end local v21    # "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    if-eqz v4, :cond_22
    ...
    .restart local v24    # "$i$f$substringWhile":I
    .restart local v25    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v26    # "$i$f$skipWhile":I
    :cond_22
    nop
    ...
    invoke-static {v11, v12, v0}, Lkotlin/time/DurationKt;->toDuration(JLkotlin/time/DurationUnit;)J
    ...
    invoke-static {v11, v12, v0}, Lkotlin/time/DurationKt;->toDuration(DLkotlin/time/DurationUnit;)J
