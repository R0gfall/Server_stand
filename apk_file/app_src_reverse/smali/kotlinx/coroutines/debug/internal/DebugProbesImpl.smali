...
.method private final dumpCoroutinesInfoImpl(Lkotlin/jvm/functions/Function2;)Ljava/util/List;
    ...
    new-instance v8, Lkotlinx/coroutines/debug/internal/DebugProbesImpl$dumpCoroutinesInfoImpl$lambda-12$$inlined$sortedBy$1;

    invoke-direct {v8}, Lkotlinx/coroutines/debug/internal/DebugProbesImpl$dumpCoroutinesInfoImpl$lambda-12$$inlined$sortedBy$1;-><init>()V
    ...
    invoke-static {v8, v6}, Lkotlin/sequences/SequencesKt;->mapNotNull(Lkotlin/sequences/Sequence;Lkotlin/jvm/functions/Function1;)Lkotlin/sequences/Sequence;
    ...
    .line 155
    .local v6, "$i$a$-check-DebugProbesImpl$dumpCoroutinesInfoImpl$1$1":I
    :try_start_1
    const-string v7, "Debug probes are not installed"

    .end local v6    # "$i$a$-check-DebugProbesImpl$dumpCoroutinesInfoImpl$1$1":I
...
.method private final sanitizeStackTrace(Ljava/lang/Throwable;)Ljava/util/List;
    ...
    sget-boolean v2, Lkotlinx/coroutines/debug/internal/DebugProbesImpl;->sanitizeStackTraces:Z
...
.method public final hierarchyToString(Lkotlinx/coroutines/Job;)Ljava/lang/String;
    ...
    .line 116
    .local v8, "jobToStack":Ljava/util/Map;
    new-instance v3, Ljava/lang/StringBuilder;
    ...
    .local v5, "$this$hierarchyToString_u24lambda_u2d9_u24lambda_u2d8":Ljava/lang/StringBuilder;
    const/4 v6, 0x0

    .line 117
    .local v6, "$i$a$-buildString-DebugProbesImpl$hierarchyToString$1$2":I
    sget-object v7, Lkotlinx/coroutines/debug/internal/DebugProbesImpl;->INSTANCE:Lkotlinx/coroutines/debug/internal/DebugProbesImpl;
    ...
    :try_start_1
    invoke-direct {v7, v10, v8, v5, v9}, Lkotlinx/coroutines/debug/internal/DebugProbesImpl;->build(Lkotlinx/coroutines/Job;Ljava/util/Map;Ljava/lang/StringBuilder;Ljava/lang/String;)V

    .line 118
    nop

    .line 116
    .end local v5    # "$this$hierarchyToString_u24lambda_u2d9_u24lambda_u2d8":Ljava/lang/StringBuilder;
    .end local v6    # "$i$a$-buildString-DebugProbesImpl$hierarchyToString$1$2":I
    invoke-virtual {v3}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
    ...
    .end local v8    # "jobToStack":Ljava/util/Map;
    :goto_5
    if-ge v0, v2, :cond_6
